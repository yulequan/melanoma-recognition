...
template <typename Dtype>
void im2col_cpu_deeplab(const Dtype* data_im, 
...
// Explicit instantiation
template void im2col_cpu_deeplab<float>(const float* data_im,
    const int num, const int channels, const int height, const int width,
    const int kernel_h, const int kernel_w, const int pad_h, const int pad_w,
    const int stride_h, const int stride_w, const int hole_h, const int hole_w,
    float* data_col);
template void im2col_cpu_deeplab<double>(const double* data_im,
    const int num, const int channels, const int height, const int width,
    const int kernel_h, const int kernel_w, const int pad_h, const int pad_w,
    const int stride_h, const int stride_w, const int hole_h, const int hole_w,
    double* data_col);
...
template <typename Dtype>
void col2im_cpu_deeplab(const Dtype* data_col,
    const int num, const int channels, const int height, const int width,
    const int kernel_h, const int kernel_w, const int pad_h, const int pad_w,
    const int stride_h, const int stride_w, const int hole_h, const int hole_w,
    Dtype* data_im) {
...
// Explicit instantiation
template void col2im_cpu_deeplab<float>(const float* data_col,
    const int num, const int channels, const int height, const int width,
    const int kernel_h, const int kernel_w, const int pad_h, const int pad_w,
    const int stride_h, const int stride_w, const int hole_h, const int hole_w,
    float* data_im);
template void col2im_cpu_deeplab<double>(const double* data_col,
    const int num, const int channels, const int height, const int width,
    const int kernel_h, const int kernel_w, const int pad_h, const int pad_w,
    const int stride_h, const int stride_w, const int hole_h, const int hole_w,
    double* data_im);
